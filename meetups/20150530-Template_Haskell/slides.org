...
#+REVEAL_HLEVEL: 2
#+REVEAL_PLUGINS: ()
#+REVEAL_TITLE_SLIDE_TEMPLATE: <h1>%t</h1><h4 style="margin-top: 100px">%a (%e)</h4><h4>%d</h4><h4><a href="http://bit.do/nilcons-th">http://tiny.cc/nilcons-th</a></h4><h4 style="padding-top: 220px">© 2015 Gergely Risko, All rights reserved.</h4>
